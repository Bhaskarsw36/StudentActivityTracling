...
extends HttpServlet
{
	...
	throws ServletException, IOException 
	{
		...
		{
			//1. Load the Driver
			Class.forName("com.mysql.jdbc.Driver").newInstance();// Driver d=new Driver();
			
			//2. Get the DB Connection via Driver 
			String dbUrl = "jdbc:mysql://localhost:8085/becm78_db?user=root&password=system";
